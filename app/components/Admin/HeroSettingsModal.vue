      ...
      >
        ...
        >
          <div v-if="isOpen" class="bg-white rounded-3xl p-6 sm:p-8 shadow-2xl max-w-md w-full relative overflow-visible transform transition-all">
            ...
            <div class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-amber-100 to-transparent rounded-bl-full opacity-50 -z-10"></div>
            
            <!-- Header -->
            <div class="flex items-center justify-between mb-6">
              <h3 class="text-xl sm:text-2xl font-bold text-gray-800 flex items-center gap-2">
                <Icon name="lucide:settings" class="text-amber-500" />
                首頁飾品設定
              </h3>
            ...
            <div class="space-y-6">
              ...
              <div>
                ...
                <div class="relative">
                  <select v-model="selectedRow1" class="w-full pl-4 pr-10 py-3 appearance-none rounded-xl border-2 border-gray-200 focus:border-amber-500 focus:outline-none transition-colors bg-gray-50 font-medium text-gray-700">
              ...
              <div>
                ...
                <div class="relative">
                  <select v-model="selectedRow2" class="w-full pl-4 pr-10 py-3 appearance-none rounded-xl border-2 border-gray-200 focus:border-amber-500 focus:outline-none transition-colors bg-gray-50 font-medium text-gray-700">
                    <option v-for="cat in categories" :key="cat.id" :value="cat.id">
                      {{ cat.name }} ({{ cat.nameEn }})
                    </option>
                  </select>
            ...
            <div class="mt-8 flex gap-3">
              ...
              <button @click="save" :disabled="isConfigLoading" class="flex-1 px-4 py-3 rounded-xl font-bold text-white bg-amber-500 hover:bg-amber-600 shadow-md shadow-amber-200 transition-all flex items-center justify-center gap-2">
