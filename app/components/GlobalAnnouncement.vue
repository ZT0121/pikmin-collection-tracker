      ...
      <div class="glass-surface-readable announcement-panel pointer-events-auto max-w-md w-full rounded-3xl p-4 flex flex-col gap-3">
          ...
          <div class="flex items-center gap-2">
            ...
            <div class="flex gap-1">
              <button 
                ...
                :class="currentTab === 'update' ? 'bg-amber-500 text-white shadow-sm' : 'glass-control text-gray-700 hover:text-amber-700'"
              >
                📢 更新
              </button>
              <button 
                ...
                class="px-2 py-1 text-xs rounded-full transition-colors"
                :class="currentTab === 'event' ? 'bg-amber-500 text-white shadow-sm' : 'glass-control text-gray-700 hover:text-amber-700'"
              >
                🎉 活動
              </button>
            </div>
        ...
        <div v-show="currentTab === 'update'" class="flex-1">
          <ul class="announcement-copy text-sm leading-relaxed list-disc list-inside space-y-1">
            ...
            <li>3/14 主頁現在會顯示<span class="text-amber-600 font-medium">當月全新與復刻的裝飾品</span>皮克敏了!新增<span class="bg-gradient-to-r from-yellow-400 via-red-500 to-purple-600 bg-clip-text text-transparent font-bold">彩色粉末皮克敏系列</span></li>
        ...
        <div v-show="currentTab === 'event'" class="flex-1">
          <div class="flex gap-3 items-center">
            ...
            <div class="announcement-copy text-sm space-y-1">
              <p class="font-medium text-amber-600">🚶 走路集點優惠！</p>
              ...
              <p class="text-xs flex items-center gap-1">
                ...
                <button 
                  ...
                  class="font-mono glass-control px-1.5 py-0.5 rounded active:bg-amber-200 transition-colors cursor-pointer inline-flex items-center gap-1"
                ...
                >
                  ...
                  <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 text-amber-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="w-full glass-control rounded-full h-1 overflow-hidden">
          <div class="bg-amber-500 h-full transition-all duration-[10000ms] ease-linear w-full" :class="{ '!w-0': startProgress }"></div>
        </div>
      </div>
    </div>
  </Transition>
