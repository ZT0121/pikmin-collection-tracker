<template>
  <button
    ...
    class="border-2 border-black flex items-center justify-center w-10 h-10 rounded-xl bg-white/60 hover:bg-white text-gray-500 hover:text-amber-600 transition-all"
