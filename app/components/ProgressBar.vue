<template>
  <div>
    <div class="flex items-center justify-between mb-1" v-if="label">
      ...
      <span class="text-sm font-bold text-[#746450]">{{ percentage }}%</span>
    </div>
    <div class="h-2.5 bg-gray-200 rounded-full overflow-hidden">
      <div 
        class="h-full bg-gradient-to-r from-[#c8bba4] to-[#9d9588] transition-all duration-700 ease-out rounded-full"
