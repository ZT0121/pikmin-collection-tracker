  ...
  <div class="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="text-center animate-slide-up">
      ...
      <div v-if="!error" class="glass rounded-3xl p-12 shadow-2xl">
        <div class="w-24 h-24 mx-auto bg-gradient-to-br from-amber-400 to-stone-500 rounded-full flex items-center justify-center mb-6 shadow-xl shadow-amber-200">
        ...
        <div class="flex justify-center gap-1.5 mt-6">
          <div class="w-2.5 h-2.5 bg-amber-400 rounded-full animate-bounce" style="animation-delay: 0s;"></div>
          <div class="w-2.5 h-2.5 bg-amber-400 rounded-full animate-bounce" style="animation-delay: 0.1s;"></div>
          <div class="w-2.5 h-2.5 bg-amber-400 rounded-full animate-bounce" style="animation-delay: 0.2s;"></div>
        </div>
      </div>

      <!-- Error State -->
      <div v-else class="glass rounded-3xl p-12 shadow-2xl max-w-md">
        <div class="w-24 h-24 mx-auto bg-gradient-to-br from-red-400 to-amber-500 rounded-full flex items-center justify-center mb-6 shadow-xl shadow-red-200">
